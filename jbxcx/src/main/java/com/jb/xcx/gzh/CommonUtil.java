...
public class CommonUtil {
    ...
    *
    */
    private static Logger log = LoggerFactory.getLogger(CommonUtil.class);//定义日志获取状态输出

    // 凭证获取
    // 获取access_token  https://api.weixin.qq.com/cgi-bin/qrcode/create?access_token=TOKEN
    public final static String token_url = "https://api.weixin.qq.com/cgi-bin/token?grant_type=client_credential&appid=APPID&secret=APPSECRET";

    //获取素材列表  https://mp.weixin.qq.com/mp/homepage?__biz=MzU2ODg3MTA3MQ==&hid=1&sn=2fdbd291eaa08c7d4f85dc3c93944f96&scene=18
    //
     ...
     * @return
     */
    public static List<Material> getMaterial(String accessToken, String type, int offset, int count) throws JSONException {
     ...
     * @return
     */
    public static Token getToken(String appid, String appsecret) throws JSONException {
        Token token = null;
        String requestUrl = token_url.replace("APP_ID", appid).replace("APP_SECRET", appsecret);//替换相应的参数
        // 发起GET请求获取凭证
